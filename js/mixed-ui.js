  ...
  _metaForm(t) {
    ...
    return `
      ...
      <div id="team-names-block" class="${isGenerated || isPlayoffPhase ? 'hidden' : ''}">
        ...
        ${!isPlayoffPhase ? '<div class="generate-actions"><button type="button" class="btn btn-success" id="btn-generate-sequential">Распределить команды</button><button type="button" class="btn btn-ghost" id="btn-generate">Сгенерировать игры</button></div>' : ''}
      </div>
    `;
  },
